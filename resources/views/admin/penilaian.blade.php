...
<div class="col-12" style="margin-bottom:12px;">
    <div class="card" style="background:#f4f6f9;border:none  !important;">
        <div class="card-body">
            ...
            <a href="#" class="btn btn-success"><i class="fa fa-check"></i> Penilaian</a>
        </div>
    </div>
</div>
        ...
        <div class="col-sm-12 col-xl-12 col-xs-12 col-md-12 col-lg-12" style="margin-bottom:12px;">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-dark"><i class="fa fa-check"></i> Nilai Siswa</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form method="post" action="/admin/import/penilaian" enctype="multipart/form-data">
                    ...
                    <table
                        ...
                        <thead>
                            ...
                            <th data-field="mapel" data-filter-control="select">Mapel</th>
                            <th data-field="nilai1">P1</th>
                            <th data-field="nilai2">P2</th>
                            <th data-field="nilai3">P3</th>
                            <th data-field="nilai4">P4</th>
                            <th data-field="nilai5">P5</th>
                            </tr>
                        </thead>
                    </table>
                </div>
